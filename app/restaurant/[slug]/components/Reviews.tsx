            ...
            <div className="ml-10 w-5/6">
              ...
              <div className="mt-5">
                <p className="text-lg font-light">
                  Comida exquisita, el ambiente y la atención es muy buena. Eso
                  si no estaba disponible el pulpo ni el salmón cuando fuimos y
                  nos quedamos con las ganas, pero salvo eso todo lo demás
                  excelente.
                </p>
              </div>
            </div>
